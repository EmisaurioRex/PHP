        ...
        <div class="row">
            <div class="col-md-4">
                <div class="card shadow-sm p-3 mb-4">
                    ...
                    <form method="POST" action="<?php echo !empty($producto_a_editar) ? 'modificar.php' : 'agregar.php'; ?>"> 
                                ...
                                <?php foreach ($productos as $p): ?>
                                    <tr class="producto-row">
                                        ...
                                        <td>
                                            ...
                                            <form method="POST" action="eliminar.php" class="d-inline" onsubmit="return confirm('¿Estás seguro de que quieres eliminar el producto: <?php echo htmlspecialchars($p[1]); ?>?');"> 
